...
Date=[2019 05 12]; //Messdatum
windfactor=1;
timedifference=0; //zeitunterschied: controltime-windtime in s
RPM_Factor=1; // Bis einschließlich 2019 04 16 13 00 26, Danach 1
filedir="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 05 12 10 56 02\2019 05 12 10 56 02_wind.txt";
...
Data_neu=[Datevec_neu RPM_neu v1_neu lambda_neu];
text_neu=['Year Month Day Hour Minute Second RPM_Turb v1_new lambda']
...
filedir_neu=strcat([filedir_neu, '_v3.txt']);
