...
filedir_w="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 05 12 10 56 02\2019 05 12 10 56 02_wind_v2.txt"; //Nur _v2.txt Daten
filedir_c="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 05 12 10 56 02\2019 05 12 10 56 02.txt";
...
//    gap(i)=(c_dt_gap(i)+1)-(c_dt_gap(i));
    Datenum_c_gapfill=Datenum_c_work(c_dt_gap(i)):1/(24*60*60):Datenum_c_work(c_dt_gap(i)+1); //3 Sek. Daten erstellen
...
//////2019 05 12 10 17 42
//x_MS_RPM_erreicht_start=180;
//x_MS_RPM_erreicht_stop=812;
//////2019 05 12 10 42 34
//x_MS_RPM_erreicht_start=166;
//x_MS_RPM_erreicht_stop=263;
//////2019 05 12 10 56 02
x_MS_RPM_erreicht_start=175;
x_MS_RPM_erreicht_stop=702;
...
MS_RPM_work=interpln([Datenum_neu(x_MS_RPM_nonan)';MS_RPM_work(x_MS_RPM_nonan)'],Datenum_neu);
...
filedir_neu=strcat([filedir_neu, '_all_v3.txt']);
