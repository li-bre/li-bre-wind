...
filedir_w="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 04 16 15 52 04\2019 04 16 15 52 04_wind_v2.txt";; //Nur _v2.txt Daten
filedir_c="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 04 16 15 52 04\2019 04 16 15 52 04.txt";
...
Datenum_c_work=Datenum_c;
        //Uhrzeit rekonstruieren
        Datenum_c_dt=Datenum_c_work(2:length(Datenum_c_work))-Datenum_c_work(1:length(Datenum_c_work)-1);
        Datenum_c_dt(2)=1/(24*3600);
        Datenum_c_work(2:length(Datenum_c_work))=Datenum_c_work(2)+Datenum_c_dt;
