...
// PINS /////////////
  ...
  int MS_V1_target=32; //Voltage for Motor Start Up
...
//  int SU=0;
  ...
  unsigned long SU_start_time_max=1500;
  int SU_MS=0;
  ...
  const int SU_P_1_max= 55; //Maximale Leistung
...
//  Serial.println("card initialized.");
  ...
  TCCR0B = (TCCR0B & 0b11110) | 0x03;
  TCCR1B = (TCCR1B & 0b11110) | 0x01;
  TCCR2B = (TCCR2B & 0b11110) | 0x03;
...
//    while (MS_DCDC_PWM<(MS_DCDC_PWM_0-10) || V_1>14) {
//      if (MS_DCDC_PWM>=(MS_DCDC_PWM_0-10)) MS_DCDC_PWM=(1-((V_1-V_2)/V_1))*255;
