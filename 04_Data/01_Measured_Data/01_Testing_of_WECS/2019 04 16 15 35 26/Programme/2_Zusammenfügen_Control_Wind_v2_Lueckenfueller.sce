...
filedir_w="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 04 16 15 35 26\2019 04 16 15 35 26_wind_v2.txt"; //Nur _v2.txt Daten
filedir_c="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 04 16 15 35 26\2019 04 16 15 35 26.txt";
...
Data_c_work=Data_c;
    ...
    Datenum_c_work(length(Datenum_c_work))+120/(24*60*60); //Hier Sekunden eintragen 
...
filedir_neu=strcat([filedir_neu, '_all_v2.txt']);
