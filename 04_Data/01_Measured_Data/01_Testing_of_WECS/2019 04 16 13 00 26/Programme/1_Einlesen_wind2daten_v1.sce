...
filedir="Testen\Daten_bearbeitet\2019 04 16 13 00 26\2019 04 16 13 00 26_wind_2.txt";

filedir=strcat([path,filedir]);


Date=[2019 04 16]; //Messdatum
windfactor=1.4;
timedifference=42; //zeitunterschied: controltime-windtime
RPM_Factor=3; // Bis einschließlich 2019 04 16 13 00 26, Danach 1
//filedir="C:\Users\J B\tubcloud\Module\Masterarbeit\Testen\Daten_bearbeitet\2019 04 16 13 00 26\2019 04 16 13 00 26_wind_2.txt";
